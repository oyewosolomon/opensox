    ...
    <nav className="absolute top-0 left-0 right-0 p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="absolute flex place-items-center left-1/2 transform -translate-x-1/2">
          ...
          />
          <span className='text-white font-bold text-xl md:2xl'>
            Opensox
          </span>
        </div>
        ...
        <div className="relative">
          ...
          <div className="hidden md:flex items-center">
            <div className="relative">
              <input 
                type="text" 
                className="pl-10 pr-4 py-2 rounded-lg bg-white/10 text-white placeholder-white/70 border border-white/20 focus:outline-none focus:border-white/40 w-64"
                placeholder="Search..."
                value={searchQuery}
